...
- **`use std::ml::{conv, relu, max_pool}`** — stdlib ops for convolution, activation, and pooling. In [demos/](https://github.com/einlang/einlang/tree/main/examples/demos) you wrote convolutions by hand; here you use the library.
