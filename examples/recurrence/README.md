...
|------|--------------|-----|
| **[recurrence_suite.ein](recurrence_suite.ein)** | Fibonacci, logistic map, Markov stationary (ψ = ψ P), random walk | `python3 -m einlang examples/recurrence/recurrence_suite.ein` |
