...
[examples/README.md](../examples/README.md) — learning path and list by domain (simulation, finance, optimization, ML, etc.). Run from repo root: `python3 -m einlang examples/hello.ein`.
