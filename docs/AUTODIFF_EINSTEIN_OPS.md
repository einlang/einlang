...
| **5. 2D Convolution** | conv2d, ∂y/∂x, ∂y/∂w, ∂y/∂b | — | `test_einstein_conv_2d_where_clause` (Einstein `sum[kh,kw]`); 1D: `test_einstein_conv_1d_where_clause`. IR catalog: `conv2d` in `_IR_DUMP_OPS`. |
