...
| **Why Einlang? (features & comparison)** | [Why Einlang](https://github.com/einlang/einlang/blob/main/docs/WHY_EINLANG.md) — math-on-the-page, one language for simulation + ML, gradients without gradient code, autodiff instead of finite-difference estimates where supported |
...
| **Autodiff / gradients** | **Compiler-native AD** — not a bolt-on: `@a / @b` and `@expr` are in the language; the compiler lowers derivatives, builds pullbacks, and wires gradient slots. Train models, differentiate simulations, and use quotients with one mechanism. For supported ops, this is the direct replacement for finite-difference sensitivity checks. [AUTODIFF_HIGHLIGHTS](https://github.com/einlang/einlang/blob/main/docs/AUTODIFF_HIGHLIGHTS.md) (narrative) · [AUTODIFF_DESIGN](https://github.com/einlang/einlang/blob/main/docs/AUTODIFF_DESIGN.md) · [Pipeline](https://github.com/einlang/einlang/blob/main/docs/AUTODIFF_PIPELINE.md) · [Ops](https://github.com/einlang/einlang/blob/main/docs/AUTODIFF_OPS.md) · [PRINT_DIFFERENTIAL](https://github.com/einlang/einlang/blob/main/docs/PRINT_DIFFERENTIAL.md) | [autodiff_small.ein](https://github.com/einlang/einlang/blob/main/examples/autodiff_small.ein), [autodiff_matmul.ein](https://github.com/einlang/einlang/blob/main/examples/autodiff_matmul.ein) · [reference.md](https://github.com/einlang/einlang/blob/main/docs/reference.md) |
...
| [WHY_EINLANG](https://github.com/einlang/einlang/blob/main/docs/WHY_EINLANG.md) | **Why Einlang?** — Feature brag: math-on-the-page syntax, one language for simulation + ML, gradients without gradient code, autodiff instead of finite differences where supported, who it's for |
...
| [Autodiff design](https://github.com/einlang/einlang/blob/main/docs/AUTODIFF_DESIGN.md) | **Automatic differentiation is a language feature**: `@expr`, `@a / @b`, quotients, and `print(@y)`; full compiler pipeline from source to NumPy execution, used in place of finite-difference probing where supported |
