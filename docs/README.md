...
- [The Name in the Bracket](https://einlang.github.io/einlang/book/): a book about what notation hides, and what happens when you refuse to let it.
...
- [Paper](https://einlang.github.io/einlang/einlang_paper.pdf): the compact language-design argument.
- [Thesis-form report](https://einlang.github.io/einlang/einlang_thesis.pdf): the fuller implementation writeup with compiler algorithms.
