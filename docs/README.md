...
| **Understand autodiff** | [AUTODIFF](https://github.com/einlang/einlang/blob/main/docs/AUTODIFF.md) |
...
| [AUTODIFF](https://github.com/einlang/einlang/blob/main/docs/AUTODIFF.md) | Unified autodiff documentation |
...
| **How do I get derivatives?** | Bind the value first, then use `@name`, `@a / @b`, `@loss / @w`, or `@C / @A`; see [AUTODIFF](https://github.com/einlang/einlang/blob/main/docs/AUTODIFF.md) |
...
| Area | Docs |
|------|------|
| **Autodiff internals** | [AUTODIFF](https://github.com/einlang/einlang/blob/main/docs/AUTODIFF.md) |
| **Autodiff historical notes** | See [AUTODIFF](https://github.com/einlang/einlang/blob/main/docs/AUTODIFF.md) |
| **Einstein / lowering details** | [AUTODIFF](https://github.com/einlang/einlang/blob/main/docs/AUTODIFF.md) · [VECTORIZATION_DESIGN](https://github.com/einlang/einlang/blob/main/docs/VECTORIZATION_DESIGN.md) · [RECURRENCE_ORDER_DESIGN](https://github.com/einlang/einlang/blob/main/docs/RECURRENCE_ORDER_DESIGN.md) |
