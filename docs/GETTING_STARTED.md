...
| **Try autodiff** | [Autodiff](https://github.com/einlang/einlang/blob/main/docs/AUTODIFF.md) · run `python3 -m einlang examples/autodiff_small.ein` or [autodiff_matmul.ein](https://github.com/einlang/einlang/blob/main/examples/autodiff_matmul.ein) to see expression-level derivatives and tensor quotients in place; for supported ops this is the preferred alternative to finite-difference estimates |
