...
- [Einlang: Formulas as Code](https://einlang.github.io/einlang/book/) is the book-style path through the core abstractions: indexed data, recurrence, local derivatives, and storage.
